            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav mr-1">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle text-white" href="#" id="cartDropDown" href="#" data-toggle="dropdown" aria-haspopup="true"
                            aria-expanded="false">
                            Cart
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="cartDropDown">
                            ...
                            <div>
                                <a class="btn btn-success btn-sm mr-1" href="_cart/cart.php" style="float: right">Check out</a>
                            </div>
                            <div>
                    ...
                    <!-- sign up button -->
                    <li class="nav-item">
                        <a class="nav-link text-white" href="_registration_form/registration_form.php">SignUp</a>
                    </li>
                </ul>
